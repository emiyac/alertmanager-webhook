...
async def send_msg_to_wechat(items: AlertManagerModel, tmpl: str = settings.WECHAT_TEMPLATE):
...
async def send_msg_to_dingtalk(items: AlertManagerModel, tmpl: str = settings.DINGTALK_TEMPLATE):
    logger.debug("items is: {}".format(items))
